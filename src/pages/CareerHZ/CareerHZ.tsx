        ...
        <div className="wrapper">
          ...
          {showScrollButtons && (
            <div className="scroll-buttons">
              <svg id="svg" className="scroll-button left" onClick={scrollLeft} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="28" height="28" viewBox="0, 0, 400,400">
                <g id="svgg">
